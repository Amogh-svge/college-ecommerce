...
<body class="container">
    ...
    <div class="form-container">
        <div class="form-image"><img src="images/blog.jpg" alt=""></div>
        <!-- Session Status -->
        ...
        <form class="form" method="POST" action="{{ route('login') }}">
            ...
            <div class="form-partition">
                ...
                <div class="form-check ">
                    <span>
                        <input id="remember_me" type="checkbox" name="remember"><label for="">Remember me</label>
                    </span>
                    @if (Route::has('password.request'))
                ...
                <div class="form-rows" style="margin-top: 30px" > <a href="{{ route('register') }}"><center>{{'Not a member? Sign up now'}}</center></a></div>
