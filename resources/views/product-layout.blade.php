...
$searchVal = empty($_GET['search']) ? '' : $_GET['search']; //Search Values
$allCategories = Categories::where('parent_id', '0')->get(); // retrieve all Categories
                ...
                <div class="mobile-header__panel">
                    <div class="container">
                        <div class="mobile-header__body">
                            ...
                            <a class="mobile-header__logo" href="{{ '/' }}"><svg
                            ...
                            <div class="mobile-header__search">
                                <form class="mobile-header__search-form" method="GET"
                                    action="{{ route('search_route') }}">
                                    <input class="mobile-header__search-input" name="search"
                                        placeholder="Search over 10,000 products" aria-label="Site search"
                                        type="text" autocomplete="off" required
                                        oninvalid="this.setCustomValidity('Enter Item Name')"
                            ...
                            <div class="mobile-header__indicators">
                                ...
                                @if (Auth::id() != null)
                                    <div class="indicator indicator--mobile">
                                        <a href="{{ route('cart.index') }}" class="indicator__button"><span
                                                class="indicator__area"><svg width="20px" height="20px">
                                                    <use xlink:href="/images/sprite.svg#cart-20"></use>
                                                </svg>
                                                <span class="indicator__value">{{ count($order) }}</span></span></a>
                                    </div>
                                @endif
                                <div class="indicator indicator--mobile">
            ...
            <div class="site-header">
                ...
                <div class="site-header__middle container">
                    <div class="site-header__logo">
                        <a href="/"><svg xmlns="http://www.w3.org/2000/svg" width="196px" height="26px">
                                <path
                    ...
                    <div class="site-header__search">
                        <div class="search">
                            <form class="search__form" method="GET" action="{{ route('search_route') }}">

                                <input class="search__input" type="search" name="search"
                                    placeholder="Search over 1000 products" aria-label="Site search" type="text"
                                    autocomplete="on" required
                                    oninvalid="this.setCustomValidity('Enter Product Name')"
                                    oninput="this.setCustomValidity('')" value="{{ $searchVal }}" />
                    ...
                    <div class="site-header__phone">
                        @if (Auth::user() == null)
                            <div class="indicator">
                                <a href={{ route('register') }} class="site-header__register"><span
                                        class="indicator__area"> <img src="/images/register.png" width="25px"
                                            height="25px" alt="">&nbsp;Register</span></a>
                            </div>
                        @else
                            <div class="indicator ">
                                ...
                                <div class="nav-panel__indicators">
                                    @if (Auth::id() != null)
                                        <div class="indicator indicator--trigger--click">
                                            <a href="#" class="indicator__button"><span
                                                    class="indicator__area"><svg width="20px" height="20px">
                                                        <use xlink:href="/images/sprite.svg#cart-20"></use>
                                                    </svg>
                                                    <span
                                                        class="indicator__value">{{ Auth::id() != null ? count($order) : '0' }}</span></span></a>
                                                            ...
                                                            @foreach ($order as $item)
                                                                <div class="dropcart__product">
                                                                    <div class="dropcart__product-image">
                                                                        <a href="/products/{{ $item->product_id }}"><img
                                                                    ...
                                                                    <div class="dropcart__product-info">
                                                                        <div class="dropcart__product-name">
                                                                            <a
                                                                                href="/products/{{ $item->product_id }}">{{ $item->prod_name }}</a>
                                                                        </div>
                                                                        ...
                                                                        <div class="dropcart__product-meta">
                                                                            <span
                                                                                class="dropcart__product-quantity">{{ $item->quantity }}</span>
                                                                            x
                                                                            <span class="dropcart__product-price">Rs.
                                    ...
                                    <div class="indicator">
                                        <div class="nav-links__item nav-links__item--with-submenu">
                                            <!--Dropdown-->
                                            @if (Auth::check())
                                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown"
                                                    role="button" data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                                    <i class="fas fa-user-circle fa-lg mr-1" width="25px"
                                                        height="25px"></i>{{ Auth::user()->name }}
                                                </a>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="site-footer__widget footer-contacts">
                                    ...
                                    <div class="footer-contacts__text">
                                        KinBech is a new ecommerce platform where you can buy any tech items you need.
                                    ...
                                    <ul class="footer-contacts__contacts">
                                        ...
                                        <li>
                                            ...
                                            KinBechhere@gmail.com
                                        </li>
                                        <li>
                                            <i class="footer-contacts__icon fas fa-mobile-alt"></i>
                                            (+977) 9818451624, (+977) 9818451624
                                        </li>
                                        <li>
